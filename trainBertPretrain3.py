...
parser.add_argument('-model', type=str, default='output_model/4k_pure.model')
parser.add_argument('-output_val', type=str, default='results/outval_4K_pure.txt')
parser.add_argument('-output_test', type=str, default='results/outtest_4K_pure.txt')
...
class Encoder(nn.Module):
    ...
    def __init__(self, labelSize):
        ...
        self.bert = BertModel.from_pretrained('transformers/examples/chatgpt_pre2000_bert_82')
...
t=readData('dps/swbd/train_fake')
#print(len(t))
print('SWBD+5K as train set')
trainSents=preProcess(t)
#trainSents=preProcess(readData('dps/swbd/train_2K'))
valSents=preProcess(readData('dps/swbd/val'))
testSents=preProcess(readData('dps/swbd/test'))
#print(testSents[0][0])
#print(type(testSents[0][0]))
#exit(0)
id2label=['O','I']
label2id={'O':0,'I':1}
print("Read finished")
tokenizer = BertTokenizer.from_pretrained('transformers/examples/chatgpt_pre2000_bert_82', do_lower_case=False)
...
#print(trainData)
print("Train ID finished")
valData=idData(tokenizer,valSents,label2id)
#print(valData)
print("Val ID finished")
